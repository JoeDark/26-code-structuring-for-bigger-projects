...
const experience = new Experience(document.querySelector('canvas.webgl')) // If they want to add another canvas, they add it here
...
// console.log(test.oneThing.hello)
// test.anotherThing()
